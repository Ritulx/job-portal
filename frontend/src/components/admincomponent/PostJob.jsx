        ...
        >
          <div className="grid grid-cols-2 gap-5">
            <div>
              ...
              <Input
                ...
                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1 hover:shadow-pink-400"
          ...
          <div className="flex items-center justify-center mt-5">
            {loading ? (
              ...
              <Button
                type="submit"
                className="w-full px-4 py-2 text-sm text-white bg-black rounded-md hover:bg-pink-600"
              >
                Post Job
              </Button>
            )}
