    ...
    <div>
      ...
      <div className="flex items-center justify-center max-w-7xl mx-auto">
        <form
          ...
          className="w-3/4 border border-gray-500 rounded-md p-4 my-10"
        >
          ...
          {loading ? (
            ...
            <button
              type="submit"
              className="w-3/4 py-3 my-3 text-white flex items-center justify-center max-w-7xl mx-auto bg-pink-600 hover:bg-pink-800/90 rounded-md"
            >
              Login
            </button>
          )}
