...
const TermsOfService = () => {
  return (
    <div>
      ...
      <p>
        Welcome to Ritul's Job Portal. These Terms and Conditions govern your
      ...
      <p>
        ...
        are owned by or licensed to Ritul's Job Portal. You may not reproduce,
      ...
      <p>
        To the fullest extent permitted by law, Ritul's Job Portal shall not be
      ...
      <p>
        ...
        accordance with the laws of XX Jurisdiction. Any disputes arising in
        connection with these terms shall be subject to the exclusive
        jurisdiction of the courts of XX Jurisdiction.
      </p>

      <h2>8. Contact Information</h2>
      <p>
        If you have any questions about these Terms and Conditions, please
        contact us at +91 9334323122.
      </p>
    </div>
  );
};
